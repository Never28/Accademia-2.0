...
void main()
{
    ...
    while(oTarget != OBJECT_INVALID){
        sTagR = GetStringRight(GetResRef(oTarget),4);
        if(sTagR!="mb11"&&sTagR!="mb12"&&sTagR!="mb13"&&sTagR!="mb21"&&sTagR!="mb22"&&sTagR!="mb23"&&
        sTagR!="bos1"&&sTagR!="bos2"&&sTagR!="bos3"){
            ...
            else if(sTag=="craft_48"||sTag=="craft_51"||sTag=="craft_63"||sTag=="craft_75"||sTag=="craft_78"){
                nStack = GetItemStackSize(oTarget);
