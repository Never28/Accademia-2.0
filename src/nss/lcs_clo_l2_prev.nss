...
void main()
{
    ...
    int nNewLine = lcs_GetPreviousValidCloakColor(oItem, ITEM_APPR_ARMOR_COLOR_LEATHER2);

    lcs_ModifyColorandEquipNewCloak(oItem, ITEM_APPR_ARMOR_COLOR_LEATHER2, nNewLine);
    }
    else{
