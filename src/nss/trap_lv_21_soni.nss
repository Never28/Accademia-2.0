...
const int SKILL_CD_SEARCH = 40;
const int ROLL_DAMAGE = 21;
const int DAMAGE_TYPE = DAMAGE_TYPE_SONIC;
const int DAMAGE_SAVING = SAVING_THROW_TYPE_SONIC;
const int VFX_1 = VFX_IMP_SONIC;
const int VFX_2 = VFX_BEAM_EVIL;
const int VFX_3 = VFX_DUR_AURA_WHITE;
const int VFX_4 = VFX_DUR_AURA_SILENCE;
