...
void main()
{
    ...
    if(sResRef=="weap_bas_axt_4")
        ...
        nControll = 3;
    if(nControll != 0 && (GetItemPossessedBy(oPC,"crystal_mag_2")!=OBJECT_INVALID)){
        ...
        if(nGold>=32000){
            while(oItem!=OBJECT_INVALID){
                ...
                if(sTag=="crystal_mag_2"&&nItem1>0){
            ...
            IPSafeAddItemProperty(oWeap, ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_MAGICAL,IP_CONST_DAMAGEBONUS_1d6));
