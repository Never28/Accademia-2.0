...
const int SKILL_CD_SEARCH_TRAP = 10;
const int SKILL_CD_DISABLE_TRAP = 10;
const int SKILL_CD_SET_TRAP = 15;
const int SKILL_CD_CRAFT_TRAP = 10;
...
const string TRAP_SCRIPT = "trap_lv_01_elec";
