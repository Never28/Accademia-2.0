...
void main()
{
    ...
    GetAppearanceType(oPC)==APPEARANCE_TYPE_DWARF){
        ...
        if(nPheno == 0 || nPheno == 2){
            if(nSpell == 392)
                SafePolymorph(oPC, 1, 1, 1, 0, "poly_wizdrago", APPEARANCE_TYPE_DRAGON_RED);
            else if (nSpell == 393)
                SafePolymorph(oPC, 1, 0, 1, 0, "poly_wizgiant", APPEARANCE_TYPE_GIANT_FIRE);
            else if (nSpell == 394)
                SafePolymorph(oPC, 1, 0, 1, 0, "poly_wizbalor", APPEARANCE_TYPE_BALOR);
            else if (nSpell == 395)
                SafePolymorph(oPC, 1, 1, 1, 0, "poly_wizslaad", APPEARANCE_TYPE_SLAAD_DEATH);
            else if (nSpell == 396)
                SafePolymorph(oPC, 1, 0, 1, 1, "poly_wizgolem", APPEARANCE_TYPE_GOLEM_IRON);
