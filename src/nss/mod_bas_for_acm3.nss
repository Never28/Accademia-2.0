...
void main()
{
    ...
    if((sResRef=="weap_bas_lcros6"||sResRef=="weap_bas_lbow6"||sResRef=="weap_bas_sbow6"||sResRef=="weap_bas_sli6")&&
    (GetItemPossessedBy(oPC,"crystal_mag_3")!=OBJECT_INVALID)){
        ...
        if(nGold>=128000){
            ...
            IPSafeAddItemProperty(oWeap, ItemPropertyAdditional(IP_CONST_ADDITIONAL_UNKNOWN));
