...
void main()
{
    int Monk = GetLevelByClass(CLASS_TYPE_MONK,OBJECT_SELF);
    ...
    while(GetIsObjectValid(oTarget))
    {
        ...
        {
                if (nMutaLv >= 1){
                if(GetAppearanceType(OBJECT_SELF)==APPEARANCE_TYPE_WYRMLING_RED||
                GetAppearanceType(OBJECT_SELF)==APPEARANCE_TYPE_WYRMLING_GOLD||
                GetAppearanceType(OBJECT_SELF)==APPEARANCE_TYPE_WYRMLING_BRASS)
                    {
