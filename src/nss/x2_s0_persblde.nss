...
void main()
{
    ...
    if(nCasterLevel==40 && nLore>=43)
        eSummon = EffectSummonCreature("sp_perswd_4");
    else if(nCasterLevel>=31 && nLore>=34)
        eSummon = EffectSummonCreature("sp_perswd_3");
    else if(nCasterLevel>=21 && nLore>=24)
        eSummon = EffectSummonCreature("sp_perswd_2");
    else if(nCasterLevel>=13)
        eSummon = EffectSummonCreature("sp_perswd_1");
    else
        eSummon = EffectSummonCreature("sp_perswd_n");
