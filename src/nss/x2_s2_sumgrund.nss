...
void main()
{
    ...
    if(nCasterLevel==30 && nLore>=43)
        eSummon = EffectSummonCreature("sp_palegund_4");
    else if(nCasterLevel>=21 && nLore>=34)
        eSummon = EffectSummonCreature("sp_palegund_3");
    else if(nCasterLevel>=11 && nLore>=24)
        eSummon = EffectSummonCreature("sp_palegund_2");
    else if(nCasterLevel>=10)
        eSummon = EffectSummonCreature("sp_palegund_1");
    else
        eSummon = EffectSummonCreature("sp_palegund_n");
