void main()
{
    ...
    if((oItem = GetItemPossessedBy(oPC,"mod_bas_dismount"))!= OBJECT_INVALID)
        DestroyObject(oItem);
    object oMin1 = GetObjectByTag("rim_min_1");
    object oMin2 = GetObjectByTag("rim_min_2");
    object oMin3 = GetObjectByTag("rim_min_3");
    object oMinp1 = GetObjectByTag("rim_min_1_p");
    object oMinp2 = GetObjectByTag("rim_min_2_p");
    object oMinp3 = GetObjectByTag("rim_min_3_p");
