void CreaOggetto(object oPC){
    CreateItemOnObject("set_04_m_cin",oPC);
}
...
void main()
{
    ...
    int nItem1=1,nItem2=2,nItem3=3,nDiff_1,nDiff_2,nDiff_3;
    if(nGold>=2000){
        while(oItem!=OBJECT_INVALID){
            sTag = GetTag(oItem);
            if(sTag=="craft_4_mb11"&&nItem1>0){
            ...
            else if(sTag=="craft_4_mb22"&&nItem2>0){
            ...
            else if(sTag=="craft_4_bos3"&&nItem3>0){
