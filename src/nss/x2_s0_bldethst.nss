...
void  AddEnhancementEffectToWeapon(object oMyWeapon, int DamageWeap, float fDuration)
{
   ...
   IPSafeAddItemProperty(oMyWeapon, ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_ACID,nDam), fDuration, X2_IP_ADDPROP_POLICY_REPLACE_EXISTING);
   return;
}
...
void main()
{
    ...
    if(GetIsObjectValid(oMyWeapon) ){
        ...
        if (GetSlashingWeapon(oMyWeapon)){
            ...
            FloatingTextStrRefOnCreature(83621, OBJECT_SELF);
            return;
        }
    }
    else{
