...
void main()
{
    ...
    int nNewLine = lcs_GetPreviousValidHelmColor(oItem, ITEM_APPR_ARMOR_COLOR_LEATHER2);

    lcs_ModifyColorandEquipNewHelm(oItem, ITEM_APPR_ARMOR_COLOR_LEATHER2, nNewLine);
    }
    else{
