...
const int SKILL_CD_SEARCH_TRAP = 65;
const int SKILL_CD_DISABLE_TRAP = 65;
const int SKILL_CD_SET_TRAP = 80;
const int SKILL_CD_CRAFT_TRAP = 65;
const string TYPE_TRAP = "1_";
const int TYPE_T = 1;
const int DAMAGE_TYPE = DAMAGE_TYPE_ELECTRICAL;
const int DAMAGE_SAVING = SAVING_THROW_TYPE_ELECTRICITY;
const string TRAP_SCRIPT = "trap_lv_31_elec";
