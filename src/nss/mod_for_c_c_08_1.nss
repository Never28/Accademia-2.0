void CreaOggetto(object oPC){
    CreateItemOnObject("set_08_w_cin",oPC);
}
...
void main()
{
    ...
    int nItem1=6,nItem2=4,nItem3=6,nDiff_1,nDiff_2,nDiff_3;
    if(nGold>=2000){
        while(oItem!=OBJECT_INVALID){
            ...
            else if(sTag=="craft_8_scg"&&nItem2>0){
            ...
            else if(sTag=="craft_8_bos3"&&nItem3>0){
