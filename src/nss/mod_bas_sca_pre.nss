...
int nValuesSet(object oTarget){
    ...
    if(sRef=="craft_1_"||sRef=="craft_2_"||sRef=="craft_3_"||sRef=="craft_4_"||sRef=="craft_5_"||
        ...
        return 11;
    else if(sRef=="craft_13"||sRef=="craft_14"||sRef=="craft_16"||sRef=="craft_17"||
    sRef=="craft_18"||sRef=="craft_19"||sRef=="craft_20"||sRef=="craft_21"||sRef=="craft_22"||
    sRef=="craft_23"||sRef=="craft_24"||sRef=="craft_25"||sRef=="craft_26")
        return 12;
            ...
            if(n1 == n2){
                ...
                if(sResRef3=="craft"){
                    ...
                    if(n3==0)
                        ...
                        if(GetLocalInt(oPC,"scambio_1") == 0){
                            SetLocalInt(oPC,"scambio_1",1);
                            AssignCommand(oPC,SpeakString(GetName(oPC)+" ha accettato lo scambio"));
                        }
                        else{
                            AssignCommand(oPC,SpeakString("Ho gia' dato ok per lo scambio"));
                        }
                    }
                }
                else{
