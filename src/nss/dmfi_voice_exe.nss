...
void ParseEmote(string sEmote, object oPC)
{
    ...
    //*emote*
    if (FindSubString(GetStringLowerCase(sEmote), "*annuisce") != -1 ||
        FindSubString(GetStringLowerCase(sEmote), " annuisce") != -1 ||
        FindSubString(GetStringLowerCase(sEmote), "politico") != -1)
        AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_BOW, 1.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "beve") != -1 ||
             FindSubString(GetStringLowerCase(sEmote), "sorsegia") != -1)
            AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_DRINK, 1.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "beve") != -1 &&
             FindSubString(GetStringLowerCase(sEmote), "siede") != -1)
             {
    ...
    else if (FindSubString(GetStringLowerCase(sEmote), "legge") != -1 &&
             FindSubString(GetStringLowerCase(sEmote), "siede") != -1)
             {
                AssignCommand(oPC, ActionPlayAnimation( ANIMATION_LOOPING_SIT_CROSS, 1.0, 99999.0f));
    ...
    else if (FindSubString(GetStringLowerCase(sEmote), "siede")!= -1)
            {
            AssignCommand(oPC, ActionPlayAnimation( ANIMATION_LOOPING_SIT_CROSS, 1.0, 99999.0f));
            }
    else if (FindSubString(GetStringLowerCase(sEmote), "salut")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "wave") != -1)
        AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_GREETING, 1.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "sbadiglia")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "distende") != -1 ||
             FindSubString(GetStringLowerCase(sEmote), "annoiato") != -1)
        AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_PAUSE_BORED, 1.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "gratta")!= -1)
    {
        ...
        AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_PAUSE_SCRATCH_HEAD, 1.0));
             ...
             FindSubString(GetStringLowerCase(sEmote), " legge")!= -1||
             FindSubString(GetStringLowerCase(sEmote), "legge")!= -1)
        AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_READ, 1.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "onoro")!= -1)
    {
        AssignCommand(oPC,ActionUnequipItem(oRightHand));
        AssignCommand(oPC,ActionUnequipItem(oLeftHand));
        AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_SALUTE, 1.0));
    }
    else if (FindSubString(GetStringLowerCase(sEmote), "ruba")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "frega") != -1)
        AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_STEAL, 1.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "insulta")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "deride") != -1)
    {
        ...
        AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_TAUNT, 1.0));
            ...
            (FindSubString(GetStringLowerCase(sEmote), "fumo") != -1))
    {
        SmokePipe(oPC);
    }
    else if (FindSubString(GetStringLowerCase(sEmote), "acclama ")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "esulta*")!= -1)
    {
        PlayVoiceChat(VOICE_CHAT_CHEER, oPC);
        AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_VICTORY1, 1.0));
    }
    else if (FindSubString(GetStringLowerCase(sEmote), "evivva")!= -1)
    {
        PlayVoiceChat(VOICE_CHAT_CHEER, oPC);
        AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_VICTORY2, 1.0));
    }
    else if (FindSubString(GetStringLowerCase(sEmote), "celebra")!= -1)
    {
        PlayVoiceChat(VOICE_CHAT_CHEER, oPC);
        AssignCommand(oPC, PlayAnimation(ANIMATION_FIREFORGET_VICTORY3, 1.0));
    }
    else if (FindSubString(GetStringLowerCase(sEmote), "sorride")!= -1 && GetGender(oPC) == GENDER_FEMALE)
        AssignCommand(oPC, PlaySound("vs_fshaldrf_haha"));
    else if (FindSubString(GetStringLowerCase(sEmote), "cade")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "tonfa")!= -1)
        AssignCommand(oPC, ActionPlayAnimation(ANIMATION_LOOPING_DEAD_FRONT, 1.0, 99999.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "curva")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "piega")!= -1)
    ...
    else if (FindSubString(GetStringLowerCase(sEmote), "si")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "accordo")!= -1)
        AssignCommand(oPC, ActionPlayAnimation(ANIMATION_LOOPING_LISTEN, 1.0, 4.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "spunta")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "guarda")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "cerca")!= -1)
        AssignCommand(oPC,ActionPlayAnimation(ANIMATION_LOOPING_LOOK_FAR, 1.0, 99999.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "*prega")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), " prega")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "medit")!= -1)
    {
        AssignCommand(oPC,ActionUnequipItem(oRightHand));
        AssignCommand(oPC,ActionUnequipItem(oLeftHand));
        AssignCommand(oPC,ActionPlayAnimation(ANIMATION_LOOPING_MEDITATE, 1.0, 99999.0));
    }
    else if (FindSubString(GetStringLowerCase(sEmote), "ubriaco")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "confuso")!= -1)
        AssignCommand(oPC, ActionPlayAnimation(ANIMATION_LOOPING_PAUSE_DRUNK, 1.0, 99999.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "stanco")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "affaticato")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "esausto")!= -1)
    {
        PlayVoiceChat(VOICE_CHAT_REST, oPC);
        AssignCommand(oPC, ActionPlayAnimation(ANIMATION_LOOPING_PAUSE_TIRED, 1.0, 3.0));
    }
    else if (FindSubString(GetStringLowerCase(sEmote), "agitato")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "cambia")!= -1)
        AssignCommand(oPC, ActionPlayAnimation(ANIMATION_LOOPING_PAUSE2, 1.0, 99999.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "siede")!= -1 &&
             (FindSubString(GetStringLowerCase(sEmote), "pavimento")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "terra")!= -1))
        AssignCommand(oPC, ActionPlayAnimation(ANIMATION_LOOPING_SIT_CROSS, 1.0, 99999.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "domanda")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "minaccia")!= -1)
        AssignCommand(oPC, ActionPlayAnimation(ANIMATION_LOOPING_TALK_FORCEFUL, 1.0, 99999.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "ride")!= -1 ||
            FindSubString(GetStringLowerCase(sEmote), "sogghigna")!= -1)
    {
        PlayVoiceChat(VOICE_CHAT_LAUGH, oPC);
        AssignCommand(oPC, ActionPlayAnimation(ANIMATION_LOOPING_TALK_LAUGHING, 1.0, 2.0));
    }
    else if (FindSubString(GetStringLowerCase(sEmote), "chiede")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "supplica")!= -1)
    ...
    else if (FindSubString(GetStringLowerCase(sEmote), "russa")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "*sonnellino")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), " sonnechia")!= -1||
             FindSubString(GetStringLowerCase(sEmote), "sonnellino")!= -1)
        ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_SLEEP), oPC);
             ...
             FindSubString(GetStringLowerCase(sEmote), "ronza")!= -1)
        ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(VFX_DUR_BARD_SONG), oPC, 6.0f);
    else if (FindSubString(GetStringLowerCase(sEmote), "fischia")!= -1)
        AssignCommand(oPC, PlaySound("as_pl_whistle2"));
    else if (FindSubString(GetStringLowerCase(sEmote), "parla")!= -1 ||
             FindSubString(GetStringLowerCase(sEmote), "conversa")!= -1)
        AssignCommand(oPC, ActionPlayAnimation(ANIMATION_LOOPING_TALK_NORMAL, 1.0, 99999.0));
    else if (FindSubString(GetStringLowerCase(sEmote), "scuote la testa")!= -1)
    {
...
string ProcessCant(string sLetter)
{
    ...
    if (sLetter == "a" || sLetter == "A") return "*copre gli occhi*";
    if (sLetter == "b" || sLetter == "B") return "*rummoreggia*";
    if (sLetter == "c" || sLetter == "C") return "*tossisce*";
    if (sLetter == "d" || sLetter == "D") return "*aggrota la fronte*";
    if (sLetter == "e" || sLetter == "E") return "*essamina la terra*";
    if (sLetter == "f" || sLetter == "F") return "*aggrotta le giglia*";
    if (sLetter == "g" || sLetter == "G") return "*lancia uno sguardo in alto*";
    if (sLetter == "h" || sLetter == "H") return "*guarda pensieroso*";
    if (sLetter == "i" || sLetter == "I") return "*fa l'annoiato/a*";
    if (sLetter == "j" || sLetter == "J") return "*si frega il mento*";
    if (sLetter == "k" || sLetter == "K") return "*si pizzica l'orechior*";
    if (sLetter == "l" || sLetter == "L") return "*si guarda in giro*";
    if (sLetter == "m" || sLetter == "M") return "*mmm hmm*";
    if (sLetter == "n" || sLetter == "N") return "*annuisce*";
    if (sLetter == "o" || sLetter == "O") return "*sogghigna*";
    if (sLetter == "p" || sLetter == "P") return "*sorride*";
    if (sLetter == "q" || sLetter == "Q") return "*rabbrivisisce*";
    if (sLetter == "r" || sLetter == "R") return "*gira gli occhi*";
    if (sLetter == "s" || sLetter == "S") return "*si frega il naso*";
    if (sLetter == "t" || sLetter == "T") return "*si gira un po*";
    if (sLetter == "u" || sLetter == "U") return "*lancia un'occhiata pigra*";
    if (sLetter == "v" || sLetter == "V") return "*agita le mani in aria*";
    if (sLetter == "w" || sLetter == "W") return "*saluta con la mano*";
    if (sLetter == "x" || sLetter == "X") return "*allunga le mani*";
    if (sLetter == "y" || sLetter == "Y") return "*sbadiglia*";
    if (sLetter == "z" || sLetter == "Z") return "*alza le spalle*";
