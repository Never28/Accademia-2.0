...
const int SKILL_CD_SEARCH_TRAP = 40;
const int SKILL_CD_DISABLE_TRAP = 40;
const int SKILL_CD_SET_TRAP = 50;
const int SKILL_CD_CRAFT_TRAP = 40;
...
const string TRAP_SCRIPT = "trap_lv_21_elec";
