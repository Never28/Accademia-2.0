...
void main()
{
    ...
    if(sResRef=="weap_bas_axt_1")
        ...
        nControll = 3;
    if(nControll != 0 && (GetItemPossessedBy(oPC,"crystal_pos_1")!=OBJECT_INVALID)){
        ...
        if(nGold>=2000){
            ...
            IPSafeAddItemProperty(oWeap, ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_POSITIVE,IP_CONST_DAMAGEBONUS_1));
