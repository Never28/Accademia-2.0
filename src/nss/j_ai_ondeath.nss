...
************************* [Experience] ****************************************/
    ...
    int nMonsterHitDice = GetHitDice(OBJECT_SELF);
    while (oPC2 != OBJECT_INVALID){
        if (GetIsPC(oPC2)){
            if (GetArea(oPC2) == oArea && GetCurrentHitPoints(oPC2)>0) {
                ...
                int nPlayerHitDice = HitDiceByXP(oPC2);
                iXP=20;
                if((nPlayerHitDice-nMonsterHitDice)>=10)
                    iXP = 1;
                else if((nPlayerHitDice-nMonsterHitDice)>=7)
                    iXP = iXP + (nMonsterHitDice);
                else if((nPlayerHitDice-nMonsterHitDice)>=5)
                    iXP = iXP + (nMonsterHitDice*2);
                else if((nPlayerHitDice-nMonsterHitDice)>=3)
                    iXP = iXP + (nMonsterHitDice*3);
                else if((nPlayerHitDice-nMonsterHitDice)>=1)
                    iXP = iXP + (nMonsterHitDice*4);
                else if((nPlayerHitDice-nMonsterHitDice)==0)
                    iXP = iXP + (nMonsterHitDice*5);
                else if((nPlayerHitDice-nMonsterHitDice)<0&&(nPlayerHitDice-nMonsterHitDice)>-10)
                    iXP = iXP + (nMonsterHitDice*7);
                else if((nPlayerHitDice-nMonsterHitDice)<=-10)
                    iXP = 1;
                if (iXP <1)
                    iXP = 1;
                if (iXP >iMaxPx)
