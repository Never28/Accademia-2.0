...
void main()
{
    ...
    if(sResRef == "set_51_tvd" || sResRef == "set_51_tvi" || sResRef == "set_51_tvs" || sResRef == "set_49_bos"){
    ...
    else if(sResRef == "set_51_tfm" || sResRef == "set_51_tfc" || sResRef == "set_51_tfa" || sResRef == "set_50_bos"){
