...
void AddFlamingEffectToWeapon(object oTarget, float fDuration, int nCasterLvl)
{
   ...
   IPSafeAddItemProperty(oTarget, ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_NEGATIVE,nDam), fDuration, X2_IP_ADDPROP_POLICY_REPLACE_EXISTING);
...
void main()
{
    ...
    if(Aspect == APPEARANCE_TYPE_BALOR){
