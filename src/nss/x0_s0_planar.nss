    ...
    if (GetIsObjectValid(oTarget)){
        ...
        if(nAlign==ALIGNMENT_EVIL){
            if(nCasterLevel==40 && nLore>=43)
                eSummon = EffectSummonCreature("sp_evmce_6_4", VFX_FNF_SUMMON_GATE, 3.0);
            else if(nCasterLevel>=31 && nLore>=34)
                eSummon = EffectSummonCreature("sp_evmce_6_3", VFX_FNF_SUMMON_GATE, 3.0);
            else if(nCasterLevel>=21 && nLore>=24)
                eSummon = EffectSummonCreature("sp_evmce_6_2", VFX_FNF_SUMMON_GATE, 3.0);
            else if(nCasterLevel>=13)
                eSummon = EffectSummonCreature("sp_evmce_6_1", VFX_FNF_SUMMON_GATE, 3.0);
            else
                eSummon = EffectSummonCreature("sp_evmce_6_n", VFX_FNF_SUMMON_GATE, 3.0);
        }
        else if(nAlign==ALIGNMENT_GOOD){
            if(nCasterLevel==40 && nLore>=43)
                eSummon = EffectSummonCreature("sp_evmcg_6_4", VFX_FNF_SUMMON_CELESTIAL, fDelay);
            else if(nCasterLevel>=31 && nLore>=34)
                eSummon = EffectSummonCreature("sp_evmcg_6_3", VFX_FNF_SUMMON_CELESTIAL, fDelay);
            else if(nCasterLevel>=21 && nLore>=24)
                eSummon = EffectSummonCreature("sp_evmcg_6_2", VFX_FNF_SUMMON_CELESTIAL, fDelay);
            else if(nCasterLevel>=13)
                eSummon = EffectSummonCreature("sp_evmcg_6_1", VFX_FNF_SUMMON_CELESTIAL, fDelay);
            else
                eSummon = EffectSummonCreature("sp_evmcg_6_n", VFX_FNF_SUMMON_CELESTIAL, fDelay);
        }
        else {
            if(nCasterLevel==40 && nLore>=43)
                eSummon = EffectSummonCreature("sp_evmw_6_4", VFX_FNF_SUMMON_MONSTER_3, 3.0);
            else if(nCasterLevel>=31 && nLore>=34)
                eSummon = EffectSummonCreature("sp_evmw_6_3", VFX_FNF_SUMMON_MONSTER_3, 3.0);
            else if(nCasterLevel>=21 && nLore>=24)
                eSummon = EffectSummonCreature("sp_evmw_6_2", VFX_FNF_SUMMON_MONSTER_3, 3.0);
            else if(nCasterLevel>=13)
                eSummon = EffectSummonCreature("sp_evmw_6_1", VFX_FNF_SUMMON_MONSTER_3, 3.0);
            else
                eSummon = EffectSummonCreature("sp_evmw_6_n", VFX_FNF_SUMMON_MONSTER_3, 3.0);
        }
    }
    if (nCasterLevel>=13){
