...
void main()
{
    ...
    if(nCasterLevel==40 && nLore>=43)
        eSummon = EffectSummonCreature("sp_gate_4");
    else if(nCasterLevel>=31 && nLore>=34)
        eSummon = EffectSummonCreature("sp_gate_3");
    else if(nCasterLevel>=21 && nLore>=24)
        eSummon = EffectSummonCreature("sp_gate_2");
    else if(nCasterLevel>=13)
        eSummon = EffectSummonCreature("sp_gate_1");
    else
        eSummon = EffectSummonCreature("sp_gate_n");
