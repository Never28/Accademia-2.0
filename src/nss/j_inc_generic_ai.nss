...
int AI_TacticFleeHide()
{
    if(GetSkillRank(SKILL_HIDE,OBJECT_SELF,TRUE)>=1){
    // if checked at AI_StopWhatWeAreDoing.
    if(GetSkillRank(SKILL_HIDE,OBJECT_SELF,TRUE)>=1 && GetStealthMode(OBJECT_SELF)==STEALTH_MODE_ACTIVATED  && !AI_GetAIHaveEffect(GlobalEffectTrueSeeing, GlobalMeleeTarget))
    {
