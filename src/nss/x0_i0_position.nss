...
// Get a random location in the same area as given object,
// the specified distance away.
location GetRandomLocation(object oSource=OBJECT_INVALID, float fDist=0.0);
...
// We use this to get the new location
...
// Get a random location in the same area as a given object,
// the specified distance away.
location GetRandomLocation(object oSource=OBJECT_INVALID, float fDist=0.0)
{
