...
void main()
{
    ...
    if(GetAIInteger(I_AM_TOTALLY_DEAD)) return;
            DeleteLocalInt(OBJECT_SELF,"AuraDiZombie_CURRENT");
            DeleteLocalInt(OBJECT_SELF,"AuraDiSilenzio_CURRENT");
            DeleteLocalInt(OBJECT_SELF,"AuraDiInvisibilita_CURRENT");
            DeleteLocalInt(OBJECT_SELF,"AuraDiCantoFunebre_CURRENT");
            DeleteLocalInt(OBJECT_SELF,"AuraDiBattaglia_CURRENT");
            DeleteLocalInt(OBJECT_SELF,"AuraDiMutaM_CURRENT");
            DeleteLocalInt(OBJECT_SELF,"AuraDiMutaG_CURRENT");
            DeleteLocalInt(OBJECT_SELF,"AuraDiMutaE_CURRENT");
            DeleteLocalInt(OBJECT_SELF,"AuraDiBlack_CURRENT");
            DeleteLocalInt(OBJECT_SELF,"AuraDiTigre_CURRENT");
            DeleteLocalInt(OBJECT_SELF,"AuraDiTroglo_CURRENT");
            DeleteLocalString(OBJECT_SELF,"AuraDiTroglo_SALVO");
            ...
            DeleteLocalString(OBJECT_SELF,"AuraDiKill_SALVO");
            ...
            DeleteLocalString(OBJECT_SELF,"AuraDiDrago_SALVO");
            DeleteLocalInt(OBJECT_SELF,"AuraDiMorte_CURRENT");
            DeleteLocalString(OBJECT_SELF,"AuraDiMorte_SALVO");
            DeleteLocalInt(OBJECT_SELF,"AuraDiAcceca_CURRENT");
            DeleteLocalString(OBJECT_SELF,"AuraDiAcceca_SALVO");
    // Pre-death-event
      ...
      if (GetIsPC(oPC2))
        {
            if(GetArea(oPC2)==oArea){
                ...
                if(sQuest=="8"){
                    if(nQuest == 0){
                        SendMessageToPC(oPC2,"Questo Mostro faceva parte di una quest, la prossima volta cerca chi lo vuole morto");
                    }
                    else if(nQuest == 1&&GetResRef(OBJECT_SELF)=="set_11_bos"){
                        AddJournalQuestEntry("quest_"+sQuest,2,oPC2,FALSE);
                        ScritturaQuest("2",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 1&&GetResRef(OBJECT_SELF)=="set_12_bos"){
                        AddJournalQuestEntry("quest_"+sQuest,3,oPC2,FALSE);
                        ScritturaQuest("3",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 2&&GetResRef(OBJECT_SELF)=="set_12_bos"){
                        AddJournalQuestEntry("quest_"+sQuest,4,oPC2,FALSE);
                        ScritturaQuest("4",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 3&&GetResRef(OBJECT_SELF)=="set_11_bos"){
                        AddJournalQuestEntry("quest_"+sQuest,4,oPC2,FALSE);
                        ScritturaQuest("4",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 4){
                    ...
                    else if(nQuest == 1&&GetResRef(OBJECT_SELF)=="set_23_mb1"){
                        AddJournalQuestEntry("quest_"+sQuest,2,oPC2,FALSE);
                        ScritturaQuest("2",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 1&&GetResRef(OBJECT_SELF)=="set_23_bos"){
                        AddJournalQuestEntry("quest_"+sQuest,3,oPC2,FALSE);
                        ScritturaQuest("3",StringToInt(sQuest),oPC2);
                        }
                    else if(nQuest == 2&&GetResRef(OBJECT_SELF)=="set_23_bos"){
                        AddJournalQuestEntry("quest_"+sQuest,4,oPC2,FALSE);
                        ScritturaQuest("4",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 3&&GetResRef(OBJECT_SELF)=="set_23_mb1"){
                        AddJournalQuestEntry("quest_"+sQuest,4,oPC2,FALSE);
                        ScritturaQuest("4",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 4){
                    ...
                    else if(nQuest == 1&&GetResRef(OBJECT_SELF)=="set_16_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,2,oPC2,FALSE);
                        ScritturaQuest("2",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 1&&GetResRef(OBJECT_SELF)=="set_16_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,3,oPC2,FALSE);
                        ScritturaQuest("3",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 1&&GetResRef(OBJECT_SELF)=="set_17_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,4,oPC2,FALSE);
                        ScritturaQuest("4",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 1&&GetResRef(OBJECT_SELF)=="set_17_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,5,oPC2,FALSE);
                        ScritturaQuest("5",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 2&&GetResRef(OBJECT_SELF)=="set_16_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,6,oPC2,FALSE);
                        ScritturaQuest("6",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 2&&GetResRef(OBJECT_SELF)=="set_17_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,7,oPC2,FALSE);
                        ScritturaQuest("7",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 2&&GetResRef(OBJECT_SELF)=="set_17_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,8,oPC2,FALSE);
                        ScritturaQuest("8",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 3&&GetResRef(OBJECT_SELF)=="set_16_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,6,oPC2,FALSE);
                        ScritturaQuest("6",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 3&&GetResRef(OBJECT_SELF)=="set_17_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,11,oPC2,FALSE);
                        ScritturaQuest("b",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 3&&GetResRef(OBJECT_SELF)=="set_17_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,12,oPC2,FALSE);
                        ScritturaQuest("c",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 4&&GetResRef(OBJECT_SELF)=="set_16_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,7,oPC2,FALSE);
                        ScritturaQuest("7",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 4&&GetResRef(OBJECT_SELF)=="set_16_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,11,oPC2,FALSE);
                        ScritturaQuest("b",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 4&&GetResRef(OBJECT_SELF)=="set_17_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,14,oPC2,FALSE);
                        ScritturaQuest("e",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 5&&GetResRef(OBJECT_SELF)=="set_16_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,8,oPC2,FALSE);
                        ScritturaQuest("8",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 5&&GetResRef(OBJECT_SELF)=="set_16_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,12,oPC2,FALSE);
                        ScritturaQuest("c",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 5&&GetResRef(OBJECT_SELF)=="set_17_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,14,oPC2,FALSE);
                        ScritturaQuest("e",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 6&&GetResRef(OBJECT_SELF)=="set_17_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,9,oPC2,FALSE);
                        ScritturaQuest("9",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 6&&GetResRef(OBJECT_SELF)=="set_17_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,10,oPC2,FALSE);
                        ScritturaQuest("a",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 7&&GetResRef(OBJECT_SELF)=="set_16_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,9,oPC2,FALSE);
                        ScritturaQuest("9",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 7&&GetResRef(OBJECT_SELF)=="set_17_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,15,oPC2,FALSE);
                        ScritturaQuest("f",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 8&&GetResRef(OBJECT_SELF)=="set_16_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,10,oPC2,FALSE);
                        ScritturaQuest("a",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 8&&GetResRef(OBJECT_SELF)=="set_17_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,15,oPC2,FALSE);
                        ScritturaQuest("f",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 11&&GetResRef(OBJECT_SELF)=="set_16_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,9,oPC2,FALSE);
                        ScritturaQuest("9",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 11&&GetResRef(OBJECT_SELF)=="set_17_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,13,oPC2,FALSE);
                        ScritturaQuest("d",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 12&&GetResRef(OBJECT_SELF)=="set_16_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,10,oPC2,FALSE);
                        ScritturaQuest("a",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 12&&GetResRef(OBJECT_SELF)=="set_17_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,13,oPC2,FALSE);
                        ScritturaQuest("d",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 14&&GetResRef(OBJECT_SELF)=="set_16_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,15,oPC2,FALSE);
                        ScritturaQuest("f",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 14&&GetResRef(OBJECT_SELF)=="set_16_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,13,oPC2,FALSE);
                        ScritturaQuest("d",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 13&&GetResRef(OBJECT_SELF)=="set_17_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,16,oPC2,FALSE);
                        ScritturaQuest("g",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 9&&GetResRef(OBJECT_SELF)=="set_17_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,16,oPC2,FALSE);
                        ScritturaQuest("g",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 10&&GetResRef(OBJECT_SELF)=="set_17_bo1"){
                        AddJournalQuestEntry("quest_"+sQuest,16,oPC2,FALSE);
                        ScritturaQuest("g",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 15&&GetResRef(OBJECT_SELF)=="set_16_bo2"){
                        AddJournalQuestEntry("quest_"+sQuest,16,oPC2,FALSE);
                        ScritturaQuest("g",StringToInt(sQuest),oPC2);
                    }
                    else if(nQuest == 14&&GetResRef(OBJECT_SELF)=="set_16_bo1"){
