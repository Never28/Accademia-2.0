void CreaOggetto(object oPC){
    CreateItemOnObject("set_02_m_and",oPC);
}
...
void main()
{
    ...
    int nItem1=6,nItem2=6,nItem3=2,nDiff_1,nDiff_2,nDiff_3;
    if(nGold>=2000){
        while(oItem!=OBJECT_INVALID){
            sTag = GetTag(oItem);
            if(sTag=="craft_2_mor"&&nItem1>0){
            ...
            else if(sTag=="craft_2_lgu"&&nItem2>0){
            ...
            else if(sTag=="craft_2_lra"&&nItem3>0){
