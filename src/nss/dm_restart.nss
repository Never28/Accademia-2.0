...
void main()
{
    ...
    switch (nEvent)
    {
        ...
        oUser = GetPCSpeaker();
        oMod = GetModule();
        SpeakString("Il server sara riavviato in due minuti.", TALKVOLUME_SHOUT);
        DelayCommand(60.0, SpeakString("Il server sara riavviato in un minuto.", TALKVOLUME_SHOUT));
