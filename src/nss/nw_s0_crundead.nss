...
void main()
{
    ...
    if(nCasterLevel==40 && nLore>=43)
        eSummon = EffectSummonCreature("sp_crund_4");
    else if(nCasterLevel>=31 && nLore>=34)
        eSummon = EffectSummonCreature("sp_crund_3");
    else if(nCasterLevel>=21 && nLore>=24)
        eSummon = EffectSummonCreature("sp_crund_2");
    else if(nCasterLevel>=13)
        eSummon = EffectSummonCreature("sp_crund_1");
    else
        eSummon = EffectSummonCreature("sp_crund_n");
