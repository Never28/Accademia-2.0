void CreaOggetto(object oPC){
    CreateItemOnObject("set_04_m_amu",oPC);
}
...
void main()
{
    ...
    int nItem1=3,nItem2=1,nItem3=2,nDiff_1,nDiff_2,nDiff_3;
    if(nGold>=2000){
        while(oItem!=OBJECT_INVALID){
            sTag = GetTag(oItem);
            if(sTag=="craft_4_mb13"&&nItem1>0){
            ...
            else if(sTag=="craft_4_mb21"&&nItem2>0){
            ...
            else if(sTag=="craft_4_bos2"&&nItem3>0){
