void CreaOggetto(object oPC){
    CreateItemOnObject("set_08_w_amu",oPC);
}
...
void main()
{
    ...
    int nItem1=6,nItem2=4,nItem3=4,nDiff_1,nDiff_2,nDiff_3;
    if(nGold>=2000){
        while(oItem!=OBJECT_INVALID){
            ...
            else if(sTag=="craft_8_scc"&&nItem2>0){
            ...
            else if(sTag=="craft_8_bos2"&&nItem3>0){
