...
void main()
{
    ...
    int nNewLine = lcs_GetPreviousValidCloakColor(oItem, ITEM_APPR_ARMOR_COLOR_METAL1);

    lcs_ModifyColorandEquipNewCloak(oItem, ITEM_APPR_ARMOR_COLOR_METAL1, nNewLine);
    }
    else{
