void CreaOggetto(object oPC){
    CreateItemOnObject("set_05_w_elm",oPC);
}
...
void main()
{
    ...
    int nItem1=3,nItem2=3,nItem3=3,nItem4=3,nDiff_1,nDiff_2,nDiff_3,nDiff_4;
    if(nGold>=2000){
        while(oItem!=OBJECT_INVALID){
            sTag = GetTag(oItem);
            if(sTag=="craft_5_orv"&&nItem1>0){
            ...
            else if(sTag=="craft_5_goc"&&nItem2>0){
            ...
            else if(sTag=="craft_5_orm"&&nItem3>0){
            ...
            else if(sTag=="craft_5_gos"&&nItem2>0){
                nDiff_3 = GetItemStackSize(oItem);
                if(nDiff_4>nItem4){
                    SetItemStackSize(oItem,nDiff_4-nItem4);
                    nItem4=0;
                }
                else if(nDiff_4==nItem4){
                    DestroyObject(oItem,0.0);
                    nItem4=0;
                }
                else{
                    DestroyObject(oItem,0.0);
                    nItem4=nItem4-nDiff_4;
                }
            }
