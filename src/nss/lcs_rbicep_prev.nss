...
object oItem2 = GetItemInSlot(INVENTORY_SLOT_BELT,oPC);
    ...
    int nNewLine = lcs_GetPreviousValidArmor2DALine(oItem, ITEM_APPR_ARMOR_MODEL_RBICEP);

    lcs_ModifyandEquipNewArmor(oItem, ITEM_APPR_ARMOR_MODEL_RBICEP, nNewLine);
    }
    else{
